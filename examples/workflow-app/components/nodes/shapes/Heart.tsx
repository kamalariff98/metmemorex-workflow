  ...
  return (
    <div className={`relative ${selected ? 'ring-2 ring-blue-500' : ''}`}>
      ...
      <svg width="100" height="100" viewBox="0 0 100 100">
        <path d="M50 85C50 85 20 65 20 45C20 30 30 20 45 20C55 20 62 25 65 35C68 25 75 20 85 20C100 20 110 30 110 45C110 65 80 85 80 85L50 85Z" fill={selected ? '#ef4444' : '#f87171'} stroke={selected ? '#dc2626' : '#ef4444'} strokeWidth="2" />
      </svg>
